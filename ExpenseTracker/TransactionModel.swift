...
extension Category{
    ...
    static let income = Category(id:7, name: "Incom", icon: .dollar_sign)
    ...
    static let paycheque = Category(id:701, name: "Groceries", icon: .dollar_sign, mainCategoryId: 7)
    static let software = Category(id:801, name: "Restaurants", icon: .icons, mainCategoryId: 8)
    static let creditCardPayment = Category(id:901, name: "Rent", icon: .exchange_alt, mainCategoryId: 9)
}
